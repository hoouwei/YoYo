    ...
    <tr>
      <td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <div id="topnav" class="top-nav">
            <ul>
              <li><a href="privilege.php?act=logout" title="<?php echo $this->_var['lang']['signout']; ?>"><span>退出</span></a></li>
              <li><a href="index.php?act=clear_cache" target="workspace">更新缓存</a></li>
              <li><a href="" target="workspace">您好&nbsp;:&nbsp;<?php echo $_SESSION['admin_name']; ?></a></li>
                <!--privilege.php?act=modif-->
            </ul>
          </div>
