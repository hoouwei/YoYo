...
?>
    <tr>
      ...
      <td><a href="../index.php?c=goods&id=<?php echo $this->_var['booking']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><?php echo $this->_var['booking']['goods_name']; ?></a></td>
