...
/* 取得当前ecshop所在的根目录 */
defined('ADMIN_PATH') or define('ADMIN_PATH', 'supply');
...
if (!file_exists('../data/caches/compiled/supply'))
{
    @mkdir('../data/caches/compiled/supply', 0777);
    @chmod('../data/caches/compiled/supply', 0777);
}
...
$smarty->compile_dir   = ROOT_PATH . 'data/caches/compiled/supply';
if ((DEBUG_MODE & 2) == 2)
{
...
/* 验证管理员身份 */
if ((!isset($_SESSION['supply_id']) || intval($_SESSION['supply_id']) <= 0) &&
